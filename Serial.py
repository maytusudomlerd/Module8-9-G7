...
# INIT UART PORT    
Supatipunno = serial.Serial(port= 'COM6',timeout = 3, baudrate=576000,
...
def Get_Data_From_User():
    ...
    # Set Home
        ...
        print(Get_Tx_Package([Instruction]))
        Supatipunno.write(serial.to_bytes(Get_Tx_Package(Instruction=[Instruction])))
    # Ping Mode
    ...
    while(Jog_state != 99):
        ...
        if(Jog_state == str(1)):
            ...
            while(Joint_Select != str(99)):
                ...
                if(Joint_Select == str(1)):
                    Position_Robot_Joint[0] = Position_Robot_Joint[0] + \
                        Joint_Resolution
                    Joint_Number = 0x08
                elif(Joint_Select == str(2)):
                    Position_Robot_Joint[0] = Position_Robot_Joint[0] - \
                        Joint_Resolution
                    Joint_Number = 0x08
                elif(Joint_Select == str(3)):
                    Position_Robot_Joint[1] = Position_Robot_Joint[1] + \
                        Joint_Resolution
                    Joint_Number = 0x04
                elif(Joint_Select == str(4)):
                    Position_Robot_Joint[1] = Position_Robot_Joint[1] - \
                        Joint_Resolution
                    Joint_Number = 0x04
                elif(Joint_Select == str(5)):
                    Position_Robot_Joint[2] = Position_Robot_Joint[2] + \
                        Joint_Resolution
                    Joint_Number = 0x02
                elif(Joint_Select == str(6)):
                    Position_Robot_Joint[2] = Position_Robot_Joint[2] - \
                        Joint_Resolution
                    Joint_Number = 0x02
                elif(Joint_Select == str(7)):
                    Position_Robot_Joint[3] = Position_Robot_Joint[3] + \
                        Joint_Resolution
                    Joint_Number = 0x01
                elif(Joint_Select == str(8)):
                    Position_Robot_Joint[3] = Position_Robot_Joint[3] - \
                        Joint_Resolution
                    Joint_Number = 0x01
                elif(Joint_Select == str(99)):
                    Jog_state = str(99)
                else:
            ...
            if(resolution == str(1)):
                Joint_Resolution = 1
                Jog_state = 0
            elif(resolution == str(2)):
                Joint_Resolution = 10
                Jog_state = 0
            elif(resolution == str(3)):
                Joint_Resolution = 50
                Jog_state = 0
            elif(resolution == str(99)):
                Jog_state = 0
            else:
    ...
    while(Jog_state != 99):
        ...
        if(Jog_state == str(1)):
            ...
            while(Task_Select != str(99)):
                ...
                if(Task_Select == str(1)):
                    Position_Robot_Task[0] = Position_Robot_Task[0] + \
                        Task_Resolution
                elif(Task_Select == str(2)):
                    Position_Robot_Task[0] = Position_Robot_Task[0] - \
                        Task_Resolution
                elif(Task_Select == str(3)):
                    Position_Robot_Task[1] = Position_Robot_Task[1] + \
                        Task_Resolution
                elif(Task_Select == str(4)):
                    Position_Robot_Task[1] = Position_Robot_Task[1] - \
                        Task_Resolution
                elif(Task_Select == str(5)):
                    Position_Robot_Task[2] = Position_Robot_Task[2] + \
                        Task_Resolution
                elif(Task_Select == str(6)):
                    Position_Robot_Task[2] = Position_Robot_Task[2] - \
                        Task_Resolution
                elif(Task_Select == str(7)):
                    Position_Robot_Task[3] = Position_Robot_Task[3] + \
                        Task_Resolution
                elif(Task_Select == str(8)):
                    Position_Robot_Task[3] = Position_Robot_Task[3] - \
                        Task_Resolution
                elif(Task_Select == str(99)):
                    Jog_state = str(99)
                else:
                    print('Invaid command please Input in range 1-8 \n')
    ...
    for i in range(0, len(Parameter)):
        try:
            for j in range(0, len(Parameter[i])):
                Tx_Package.append(np.uint16(Parameter[i][j]))
